...
// ************************************************************ Aplicacion del PLL ************************************************************
    ...
    salida.va = PSC_U1.out[0] + uuun * NSC_U1.out[0] + uuu5 * SC_U5.out[0] + uuu7 * SC_U7.out[0];
    salida.vb = PSC_U1.out[1] + uuun * NSC_U1.out[1] + uuu5 * SC_U5.out[1] + uuu7 * SC_U7.out[1];
    salida.vc = PSC_U1.out[2] + uuun * NSC_U1.out[2] + uuu5 * SC_U5.out[2] + uuu7 * SC_U7.out[2];
