...
#define MAX_BUS_V 70   // Tension maxima admisible en el bus de CC
#define MIN_FASE_I -2     // Corriente minima (o maxima negativa) admisible en cualquier fase
#define MAX_FASE_I 2      // Corriente maxima admisible en cualqueir fase
