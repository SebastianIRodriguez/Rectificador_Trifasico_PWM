...
int imprimir_vector(float u, float theta)
{
    ...
    EPwm1Regs.CMPA.half.CMPA = PWM_COUNT_PERIOD * (1 - t_pwm1 / Ts);
    EPwm2Regs.CMPA.half.CMPA = PWM_COUNT_PERIOD * (1 - t_pwm2 / Ts);
    EPwm3Regs.CMPA.half.CMPA = PWM_COUNT_PERIOD * (1 - t_pwm3 / Ts);
