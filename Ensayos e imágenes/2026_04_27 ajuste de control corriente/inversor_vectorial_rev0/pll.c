...
SEQ_CORE SC_U3;                          // Core de componente de tercer armonico
...
float EPLL_u3 = 400;                     // Variable de ajuste para los cores (fase) - 200
...
PLL_VARS run_pll(float Vr, float Vs, float Vt)
{
    ...
    if (inicio)
    {
        ...
        SEQ_CORE_init(&SC_U3, 3, 1, EPLL_u1, EPLL_u3, TWO_PI * F_NOM, time_step);   // Tercer armonico, secuencia positiva
        SEQ_CORE_init(&SC_U5, 5, -1, EPLL_u1, EPLL_u3, TWO_PI * F_NOM, time_step);  // Quinto armonico, secuencia negativa
        SEQ_CORE_init(&SC_U7, 7, 1, EPLL_u1, EPLL_u3, TWO_PI * F_NOM, time_step);   // Septimo armonico, secuencia positiva
...
// ************************************************************ Aplicacion del PLL ************************************************************
    ...
    // float componente_x = PSC_U1.Magn.out + NSC_U1.Magn.out + SC_U5.Magn.out + SC_U7.Magn.out;
    // float componente_y = PSC_U1.Magn.out * PSC_U1.S.out[0] + NSC_U1.Magn.out * NSC_U1.S.out[0] + SC_U5.Magn.out * SC_U5.S.out[0] + SC_U7.Magn.out * SC_U7.S.out[0];
    ...
    salida.va = PSC_U1.out[0] + uuun * NSC_U1.out[0] + uuu5 * SC_U5.out[0] + uuu7 * SC_U7.out[0]; // uuu3 * SC_U3.out[0]
    salida.vb = PSC_U1.out[1] + uuun * NSC_U1.out[1] + uuu5 * SC_U5.out[1] + uuu7 * SC_U7.out[1]; // uuu3 * SC_U3.out[1]
    salida.vc = PSC_U1.out[2] + uuun * NSC_U1.out[2] + uuu5 * SC_U5.out[2] + uuu7 * SC_U7.out[2]; // uuu3 * SC_U3.out[2]
