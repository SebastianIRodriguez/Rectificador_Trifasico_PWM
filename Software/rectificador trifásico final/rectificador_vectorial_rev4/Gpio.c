/**********************************************************************
 * File: Gpio.c -- Solution File for Labs 5, 6, 7, 8, 9, 10 and 12
...
/**
 * @brief Incializa los pines digitales del convertidor
 * 	GPIO 0 y 1 <GA>: EPWM1A y EPWM1B
 * 	GPIO 2 y 3 <GA>: EPWM2A y EPWM2B
 * 	GPIO 4 y 5 <GA>: EPWM3A y EPWM3B
 * 	GPIO 10 <GA>: Salida (PWM2T-H)
 * 	GPIO 11 <GA>: Salida (Usada para debugging)
 * 	GPIO 32 <GB>: Salida (ISO-GPO2)
 * 	GPIO 34 <GB>: Salida (ISO-GPO3)
 * 	GPIO 87 <GC>: Salida (ISO-GPO1)
 */
void InitGpio(void)
{
	...
	GpioCtrlRegs.GPAPUD.all = 0x00000000; // Pullups enabled GPIO31-12, disabled GPIO11-0 ANTES 0x00000FFF
	...
	GpioCtrlRegs.GPAMUX1.bit.GPIO6 = 1; // 0=GPIO  1=EPWM4A     2=EPWMSYNCI  3=EPWMSYNCO    EPWM2R - H según la placa
	GpioCtrlRegs.GPAMUX1.bit.GPIO7 = 1; // 0=GPIO  1=EPWM4B     2=MCLKRA     3=ECAP2        EPWM2R - L según la placa
	GpioCtrlRegs.GPAMUX1.bit.GPIO8 = 0; // 0=GPIO  1=EPWM5A     2=CANTXB     3=ADCSOCAO     EPWM2S - H según la placa
	GpioCtrlRegs.GPADIR.bit.GPIO8 = 1;	// 1 = Output

	GpioCtrlRegs.GPAMUX1.bit.GPIO9 = 0; // 0=GPIO  1=EPWM5B     2=SCITXDB    3=ECAP3        EPWM2S - L según la placa
