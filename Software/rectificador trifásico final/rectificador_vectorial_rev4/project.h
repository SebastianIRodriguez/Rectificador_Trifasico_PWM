...
//
#include <rectificador/protecciones/protecciones.h>    // Protecciones por sw
#include <string.h>
...
#define PROJECT_PERIOD      7500.0  // Semi-periodo en cuentas necesario para generar una senal de 10 KHz con 150 MHz de clock base
