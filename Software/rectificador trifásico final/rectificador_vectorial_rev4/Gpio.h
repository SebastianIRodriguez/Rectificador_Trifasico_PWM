...
#define GPIO08_SET GpioDataRegs.GPASET.bit.GPIO8 = 1;
#define GPIO08_CLEAR GpioDataRegs.GPACLEAR.bit.GPIO8 = 1;

#define GPIO09_SET GpioDataRegs.GPASET.bit.GPIO9 = 1;
#define GPIO09_CLEAR GpioDataRegs.GPACLEAR.bit.GPIO9 = 1;

#define GET_PRECHARGE_RELAY_STATE (GpioDataRegs.GPADAT.bit.GPIO15) // Estado de los reles de precarga
