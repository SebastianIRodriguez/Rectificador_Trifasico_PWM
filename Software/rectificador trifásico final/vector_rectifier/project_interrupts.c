...
// Adquisicion de senales simuladas
    ...
    // Ejecución de la MEF del sistema
...
CONVERTER_STATE run_converter_mef(PLL_VARS grid, float vbus)
{
    ...
    case CONVERTER_STARTING_KP:
    {
        ...
        /*
        if (cuenta_aux > 10000 && cuenta_aux < 20000)
            Vbus_sp = 45;
        */
        //if (cuenta_aux > 2000)
            //Vbus_sp = 50;

        if ((Vbus_sp * 0.9 < vbus && vbus < Vbus_sp * 1.1) && a == 0)
        {
            cuenta_transicion++;
        }
        else
        ...
        if (cuenta_aux > 2500)
        {
            ...
            // vpi_d.x = 0;
            BOARD_CDC1_CLOSE;
            estado = CONVERTER_STARTING_KI;
        }
    }
    break;

    case CONVERTER_STARTING_KI:
    {
        ...
        if (cuenta_aux > 5000)
        {
            ...
            cuenta_aux = 0;
            estado = CONVERTER_STARTING_KI;
            // estado = CONVERTER_RISING_VBUS;
        }*/
    }
    break;

    case CONVERTER_RISING_VBUS:
    {
    }
    break;
