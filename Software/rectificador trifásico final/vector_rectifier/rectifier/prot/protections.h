 ...
 * Description: En este archivo se definen las estructuras y macros
 *              para las protecciones por software. Las mismas se
 *              accionan al superarse los umbrales definidos durante
 *              un tiempo superior al definido.
 *              Los límites medibles de cada magnitud son:
 *                  Corrientes de fase: +- 6.8 A
 *                  Tensiones RST:      +-80 V
 *                  Tensiones UvW:      +-133 V
 *                  Tension de bus1:    161 V
 *                  Tension de bus2:    268 V
 *             NO configurar protecciones que excedan esos limites,
 *             ya que no podran medirse y en consecuencia nunca se
 *             protegera al equipo
 *
 * History:
 *   13/05/2026 - original
...
#include "rectifier/prot/tripzone.h"

//**********************************************************************
// Definiciones
//
#define MAX_FAILS   100   // Cantidad de muestras fuera de rango que deben contarse para que se dispare la proteccion
...
#define MAX_BUS_V   150   // Tension maxima admisible en el bus de CC
#define MIN_FASE_I  -6    // Corriente minima (o maxima negativa) admisible en cualquier fase
#define MAX_FASE_I  6     // Corriente maxima admisible en cualqueir fase
...
//**********************************************************************
// Esta macro monitorea si alguno de los valores analogicos excede los
// limites fijados. Si lo hacen guarda la informacion de cual y lanza
// la interrupcion de trip-zone
